...
- Тесты: 59 (`npm test`), кэш сайта `shadowfox-v21`. Версия APK не поднималась.

Тематические маршруты переведены на явные списки (21.09). Следующие шаги: вычитка A2–B2, затем пункты 2–6 и 8 плана (входная проверка, достижения за устойчивые знания, лис с домиком, главная кнопка,
