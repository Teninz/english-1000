...
Версия V1.2 соединяет голову и тело в непрерывные поверхности до деформации. Грудь плавно переходит в неподвижные лапы, а поворот ушей затухает к их основанию. Добавлены движение зрачков, стабильные блики, моргание и мягкая улыбка. Эти изменения рисуются на цельной голове до деформации, поэтому глазницы и стыки лица не раскрываются.

Движение всё ещё запечено из преобразований частей, а не дорисовано в 100 новых анатомических позах. Большие повороты головы потребуют сменных нарисованных форм, а скрытую шерсть под шарфом следует дорисовать перед выпуском.
